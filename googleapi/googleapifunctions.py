...
with open(r"C:\Users\Aziz\Documents\dd\GoogleCalender_API\googleapi\zach_token.pkl", "rb") as f:
    credentials1 = pickle.load(f)
with open(r"C:\Users\Aziz\Documents\dd\GoogleCalender_API\googleapi\marc_token.pkl", "rb") as f:
    credentials2 = pickle.load(f)
with open(r"C:\Users\Aziz\Documents\dd\GoogleCalender_API\googleapi\andrew_token.pkl", "rb") as f:
    credentials3 = pickle.load(f)
# credentials3 = pickle.load(open("C:\Users\Aziz\Documents\dd\GoogleCalender_API\googleapi\andrew_token.pkl", "rb"))
...
def data_update():
    global subject_dict, Author_dict
    subject_dict = {
        'Calculations': [],
        'Clinical Pharmacy': [],
        'Pharmacy Law': [],
    ...
    for i in teacher_data:
        if i.calculations == True:
            subject_dict["Calculations"].append(i.name)
        if i.clinical_pharmacy == True:
            subject_dict["Clinical Pharmacy"].append(i.name)
        if i.pharmacy_law == True:
            subject_dict["Pharmacy Law"].append(i.name)
        if i.compounding_exam == True:
            subject_dict["Compounding Exam"].append(i.name)
        if i.general_pharmacology == True:
            subject_dict["General Pharmacology"].append(i.name)

        with open(i.credentials, "rb") as f:
            credentials = pickle.load(f)

        Author_dict[i.name] = [credentials, i.imagelink]
